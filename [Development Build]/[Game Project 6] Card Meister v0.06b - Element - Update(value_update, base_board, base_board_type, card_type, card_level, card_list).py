...
class MainIG():
    def __init__(self):
        ...
        self.card       = [ [ [], [], [], [], [] ],  [ [], [], [], [], [] ] ]
        self.board      = [ [], [] ]
        self.board_type = [base_card_enemy, base_card_enemy]
    ...
    def battle_init(self):
        ...
        Button_Image(55,  480, False, base_card_ok_inactive, base_card_ok_active, None, self.value_update)
        self.update_card()
    ...
    def value_update(self):
        ...
        if self.board[0] != []:
            for index in range(len(self.board[0])):
                card_type   = self.card[0][self.board[0][index]][0]
                card_level  = self.card[0][self.board[0][index]][1]
                card_list[card_type].append(card_level)
                
            for index in range(3):
                card_list[index] = sum(card_list[index])

            advantage_type = card_list.index(max(card_list))

            self.board_type[0] = self.base_board[advantage_type]

            print(card_list)
            print(advantage_type)
    ...
    def update(self):
        ...
        gameDisplay.blit(self.board_type[0], (240,305))
        gameDisplay.blit(self.board_type[1], (240,205))
