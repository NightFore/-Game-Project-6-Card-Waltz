...
class MainIG():
    def __init__(self):
        ...
        self.phase          = [base_1st_phase, base_2nd_phase]
        ...
        self.base_initiative    = [base_initiative_attacker, base_initiative_defender]
    ...
    def battle_init(self, enemy=WolfIG):
        ...
        # Name
        Text("%s" % self.name[0], 588.5, 482.5, Text_interface, True)
        Text("%s" % self.name[1], 212.5, 47.5,  Text_interface, True)

        # Health
        Text("Health: %s" % self.health[0], 588.5, 522.5, Text_interface, True)
        Text("Health: %s" % self.health[1], 212.5, 87.5,  Text_interface, True)
    ...
    def phase_update(self):
        ...
        for index in range(2):
            if self.phase_init[index] == True:
                transparent_image(self.phase[index], self.phase_x, 225, 225, gameDisplay)
                Setup.button    = False
    ...
    def update(self):
        ...
        gameDisplay.blit(base_status_player,    (505, 460))
        gameDisplay.blit(icon_status_iris,      (665, 460))
        pygame.draw.rect(gameDisplay, Color_Green, (510, 505, 155*self.health[0]/self.maxhealth[0], 35))
        ...
        pygame.draw.rect(gameDisplay, Color_Green, (135, 70,  155*self.health[1]/self.maxhealth[1], 35))
        ...
        for side in range(2):
            if self.battle_phase == True:
                if self.initiative[side] == True:
                    gameDisplay.blit(self.base_initiative[0], (575, 320-100*side))

                elif self.initiative[side] == False:
                    gameDisplay.blit(self.base_initiative[1], (575, 320-100*side))
