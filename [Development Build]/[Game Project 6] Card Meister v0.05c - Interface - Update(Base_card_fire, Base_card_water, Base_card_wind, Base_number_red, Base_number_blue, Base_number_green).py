...
base_card_board             = pygame.image.load("Data\Graphics\Base_card_board.png").convert()
base_card_hand_player       = pygame.image.load("Data\Graphics\Base_card_hand_player.png")
base_card_hand_enemy        = pygame.image.load("Data\Graphics\Base_card_hand_enemy.png")
...
class MainIG():
    def __init__(self):
        ...
        self.base_level = [[base_number_red_1, base_number_red_2, base_number_red_3, base_number_red_4, base_number_red_5, base_number_red_6, base_number_red_7, base_number_red_8, base_number_red_9],
                           [base_number_blue_1, base_number_blue_2, base_number_blue_3, base_number_blue_4, base_number_blue_5, base_number_blue_6, base_number_blue_7, base_number_blue_8, base_number_blue_9],
                           [base_number_green_1, base_number_green_2, base_number_green_3, base_number_green_4, base_number_green_5, base_number_green_6, base_number_green_7, base_number_green_8, base_number_green_9]]
        
        self.base_level = [[3, 3, 3], [3, 3, 3]]
        self.card       = [ [ [], [], [], [], [] ],  [ [], [], [], [], [] ] ]
        self.board      = [ [], [] ]
...
##        for side in range(2):
##            for index in range(5):
##                Text("%i" % self.card[side][index][1], 150+65*index+300*side, 540-450*side, True, Text_Card)
    ...
    def update(self):
        ...
        gameDisplay.blit(base_card_hand_player, (50,  475))
        gameDisplay.blit(base_card_hand_enemy,  (415, 25))
