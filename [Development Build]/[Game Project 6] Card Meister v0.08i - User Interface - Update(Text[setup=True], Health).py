...
class Text():
    def __init__(self, text, x, y, font, center=False, setup=True):
        """
...
class MainIG():
    ...
    def update(self):
        ...
        Text("Health: %s" % self.health[0], 589, 523, Text_interface, True, False)
        ...
        Text("Health: %s" % self.health[1], 213, 88,  Text_interface, True, False)
