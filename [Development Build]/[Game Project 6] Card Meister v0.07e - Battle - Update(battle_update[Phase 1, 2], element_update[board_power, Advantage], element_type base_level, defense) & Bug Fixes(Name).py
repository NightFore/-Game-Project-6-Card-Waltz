...
class MainIG():
    ...
    def battle_init(self, enemy=WolfIG):
        ...
        Text("%s" % self.name[0], 510, 485, Text_interface)
        Text("%s" % self.name[1], 140, 50,  Text_interface)
    ...
    def battle_update(self):
        ...
        # Battle Phase 2
            ...
            if self.initiative[0] == True:
                damage = (self.board_power[0] + self.strength[0]) - (self.board_power[1] + self.defense[1])

                if damage >= 0:
                    self.health[1] -= (self.board_power[0] + self.strength[0]) - (self.board_power[1] + self.defense[1])
            ...
            # Defensive Phase
                ...
                damage = (self.board_power[1] + self.strength[1]) - (self.board_power[0] + self.defense[0])

                if damage >= 0:
                    self.health[0] -= (self.board_power[1] + self.strength[1]) - (self.board_power[0] + self.defense[0])
