...
def Title_Screen():
    ...
    # Text
    Button(None, None, 400, 200, 800, 100, 10, True, True, Color_Red, Color_Green, None, action=PlayerIG.update_card)
...
class PlayerIG():
    ...
    def update_enemy(self):
        ...
        for index in range(5):
            len_played = [i for i in range(len(self.played[1])) if self.played[1][i] != None]
    ...
    def update(self):
        ...
        for index in range(5):
            if self.hand[1][index] != None:
                #gameDisplay.blit(, (420+65*index, 30))
                gameDisplay.blit(self.base_card[self.card[1][index][0]], (420+65*index, 30))

            else:
                gameDisplay.blit(self.base_card[self.card[1][index][0]], (305+65*index, 205))
