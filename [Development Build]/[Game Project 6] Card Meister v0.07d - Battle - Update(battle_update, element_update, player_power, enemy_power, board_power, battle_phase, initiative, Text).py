...
class MainIG():
    ...
    def battle_init(self, enemy=WolfIG):
        ...
        Text("%s" % self.name[0], 140, 50,  Text_interface)
        Text("%s" % self.name[1], 510, 485, Text_interface)
    ...
    def battle_update(self):
        # Setup
        player_power    = sum(self.board_power[0])
        enemy_power     = sum(self.board_power[1])
        ...
        # Battle Phase 2
            ...
            # Offensive Phase
            if self.initiative[0] == True:
                self.health[1] -= player_power

            # Defensive Phase
            elif self.initiative[1] == True:
                self.health[0] -= enemy_power
    ...
    def element_update(self):
        ...
        for side in range(2):
            ...
            if self.board[side] != []:
                ...
                element_type[side] = self.board_power[side].index(max(self.board_power[side]))
    ...
    def update(self):
        ...
        pygame.draw.rect(gameDisplay, Color_Green, (135, 80,  164*self.health[1]/self.maxhealth[1], 30))
