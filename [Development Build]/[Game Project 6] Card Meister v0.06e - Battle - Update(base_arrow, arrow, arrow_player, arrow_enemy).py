...
class MainIG():
    ...
    def element_update(self, side=0):
        ...
        if self.board[side] != []:
            ...
            element_type = card_list.index(max(card_list))
            self.board_element[side]    = self.base_board[element_type]
            self.banner_element[side]   = self.base_banner[element_type]
